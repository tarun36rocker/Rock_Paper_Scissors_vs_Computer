...
#IMPORTING MODEL
model = models.load_model('C:/Users/Tarun/Desktop/comp/TFExam/rock-paper-scissors/mymodel.h5')
...
while True:
    ...
    _, final_img = fpsReader.update(final_img)  # adds the fps number on the final output image
...
roi = cv2.putText(roi, res_text, (100,50), cv2.FONT_HERSHEY_SIMPLEX, 1, color, 2, cv2.LINE_AA)
roi = cv2.putText(roi, user_disp_text, (100,200), cv2.FONT_HERSHEY_SIMPLEX, 1, (150,186,122), 2, cv2.LINE_AA)
roi = cv2.putText(roi, comp_disp_text, (100,350), cv2.FONT_HERSHEY_SIMPLEX, 1, (22,56,223), 2, cv2.LINE_AA)
